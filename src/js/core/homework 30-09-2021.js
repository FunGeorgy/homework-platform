...
export class Homework11_12 extends Homework{
    ...
    constructor(config){
        super(config)
        setTimeout(()=> this.mainMethod(), 1000)
    }

    mainMethod(){
        this.inputCont = document.getElementById("inputBox");
        this.inputDiv = document.getElementById('div_input')
        this.button = document.getElementById("check_button");
        this.object = document.getElementById("object_figure");
